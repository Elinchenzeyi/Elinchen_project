...
Here are the features in our SHAP values. (just two rows for a basic description)
I will explain more feature importance with the graphs in d3graph.qmd section!
```{r}
dim(shap_values) 
